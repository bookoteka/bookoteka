...
export default function SzablonRaportRok(){
  return (
    <div className="bg-white text-slate-800 font-sans p-6" style={{ width: "794px", minHeight: "1123px" }}>
      ...
      <header className="border-b-2 border-slate-900 pb-3 mb-5 flex justify-between items-end">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Podsumowanie 2026</h1>
          ...
          <table className="w-full text-left text-xs border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-1.5 px-2.5 text-center text-slate-600 font-medium">Maj</td>
